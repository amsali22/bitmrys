...
export default function Footer() {
  return (
    <footer className="bg-slate-900/50 backdrop-blur-sm  mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/leaderboard" className="text-gray-400 hover:text-cyan-400 transition-colors flex items-center gap-2">
